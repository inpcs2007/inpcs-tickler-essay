...
* 注意：
  ...
  * 当前工程中有和Feign Client中一样的Endpoint时，Feign Client的类上不能用@RequestMapping注解否则，当前工程该endpoint http请求且使用accpet时会报404。
    @FeignClient注解的扩展讲解：参见 \[https://www.cnblogs.com/moonandstar08/p/7565442.html\] 中的描述。
...
Spring Web MVC的拦截器的扩展讲解：参见 \[http://jinnianshilongnian.iteye.com/blog/1670856/ \] 中的描述。


OkHttpTokenInterceptor

okhttp3.Interceptor的拦截器的扩展讲解：参见 \[https://blog.csdn.net/xx326664162/article/details/78044877 \] 中的描述。
