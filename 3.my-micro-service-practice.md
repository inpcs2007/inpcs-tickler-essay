...
OkHttpTokenInterceptor中的扩展讲解：参见\[[http://okeeper.leanote.com/post/使用Spring-Cloud-Feign作为HTTP客户端调用远程HTTP服务\](http://okeeper.leanote.com/post/使用Spring-Cloud-Feign作为HTTP客户端调用远程HTTP服务\)\]  中的描述。
